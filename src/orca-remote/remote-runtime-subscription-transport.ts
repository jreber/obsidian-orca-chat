...
export async function subscribeRemoteRuntimeTransport<TResult>(
  ...
  return await new Promise((resolve, reject) => {
    ...
    const requestChannel: RemoteRuntimeSubscriptionRequestChannel = new RemoteRuntimeSubscriptionRequestChannel({
      pairing,
      sharedKey,
    ...
    const frameRouter: RemoteRuntimeSubscriptionFrameRouter<TResult> =
      new RemoteRuntimeSubscriptionFrameRouter({
      sharedKey,
      serializedAuth,
      serializedRequest,
      requestId,
